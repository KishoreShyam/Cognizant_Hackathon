  ...
  return (
    <div className="flex flex-col gap-6 w-full flex-1 min-h-[calc(100vh-140px)]">
      ...
      <section
        ...
        className={`w-full overflow-hidden flex flex-col transition-none ${isFullscreen
      ...
      >
        {/* Card Header Bar */}
        <div className={`p-3.5 flex justify-between items-center shrink-0 border-b ${isFullscreen
          ...
          <div className="flex items-center gap-2">
            {embedUrl && (
              <a
                ...
                className={`p-2 rounded-lg transition-colors cursor-pointer ${isFullscreen
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors cursor-pointer flex items-center gap-1.5 text-xs font-semibold ${isFullscreen
