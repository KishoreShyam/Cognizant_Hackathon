                    ...
                    <tr key={member.id} className="hover:bg-slate-50/40 transition-colors">
                      ...
                      <td className="py-4 px-4">
                        <div className="flex flex-col gap-1.5">
                          <div className="flex">
                            <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-[12px] font-semibold bg-blue-50 text-blue-700 border border-blue-100/60 shadow-2xs">
                              {member.shap_drivers?.find(d => d.category === 'SDOH')?.display_name || member.sdoh_risk?.primary_driver || 'SDOH Factors'}
                            </span>
                          </div>
                          <span className="text-[10px] text-slate-400 pl-1">{member.county || 'California'}</span>
                        </div>
                      </td>
