...
const Overview: React.FC = () => {
  ...
  const summaryCards = [
    ...
    { title: 'High Current Risk', value: '1,240', trend: 'up', subtext: '5.1% vs last month', icon: AlertTriangle, color: 'text-error', bg: 'bg-error/10', trendColor: 'text-error', spark: generateSparkData('up'), stroke: '#ba1a1a' },
    ...
    { title: 'High Future Risk', value: '420', trend: 'up', subtext: '12% vs last month', icon: Brain, color: 'text-error', bg: 'bg-error/10', trendColor: 'text-error', spark: generateSparkData('up'), stroke: '#ba1a1a' },
          ...
          <table className="w-full text-left border-collapse min-w-[900px]">
            <thead className="text-[11px] text-on-surface-variant uppercase tracking-wider font-semibold border-b border-slate-200/40 bg-slate-50/50">
              <tr>
                ...
                <th className="p-4 w-[120px]">Current Risk</th>
